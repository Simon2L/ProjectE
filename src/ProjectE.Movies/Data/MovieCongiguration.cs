...
internal class MovieCongiguration : IEntityTypeConfiguration<Movie>
{
    ...
    public static IEnumerable<Movie> GetMovieData()
    {
        ...
        yield return new Movie(new Guid("849e8fbf-186a-4684-94ef-749c9cb97657"), "The Lord of the Rings: The Fellowship of the Ring ", 8.9, "🧝‍♀️");
        yield return new Movie(new Guid("b372fb74-26ee-41f7-9557-e00c95422609"), "The Hobbit: An Unexpected Journey", 7.8, "🧝‍♀️");
        yield return new Movie(new Guid("cb0d79d9-506e-4dfb-8805-2cddc447f819"), "The Chronicles of Narnia: The Lion, the Witch and the Wardrobe", 6.9, "🧝‍♀️");
